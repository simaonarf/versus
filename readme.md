...
### Autor: Franciel Almeida Simão

Este projeto tem como objetivo auxiliar o usuário para encontrar a melhor opção no processo de escolha de um automóvel.
...
https://abrir.link/PJwdT

# Design System:
// Link para o PDF

# Site em Produção - GitHub Pages
https://github.com/simaonarf/versus.git
...
- [x] ID 0 - Prototipa interfaces adaptáveis para no mínimo os tamanhos de tela mobile e desktop, usando ferramentas de design como Figma, Quant UX ou Sketch.
